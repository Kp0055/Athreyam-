...
// Chat
import { getConversations } from "../../controller/chat/chatController";
import searchUsers from "../../controller/doctorController/searchUsers";

router.get("/doctor/conversations", verifyToken, getConversations);
router.get("/doctor/users/search", verifyToken, searchUsers);
